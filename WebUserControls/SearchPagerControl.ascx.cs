...
using System.Text;
    ...
    // public partial class WebUserControls_WebUserControl : System.Web.UI.UserControl
...
;
        ...
        void performSearch()
        {
            String searchQuery = "http://localhost:8983/solr/lbgcconnex.ca/select?q=" + _gcsearch.queryBasic + "&rows=20";     
        }
